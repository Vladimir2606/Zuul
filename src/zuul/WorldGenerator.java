...
public class WorldGenerator {
	...
	private void addRuestungen() {
		...
		this.alleRaume.get("hexenhaus").gegenstandAblegen(new Helm("Holzhaube", "einfach aber schützend", 3, 2));
		...
		this.alleRaume.get("dorfplatz").gegenstandAblegen(new Brust("Plastahlbrustplatte", "aus gehärtetem Plastahl", 16, 12));
